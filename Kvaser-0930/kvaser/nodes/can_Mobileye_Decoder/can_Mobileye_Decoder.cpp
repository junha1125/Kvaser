/*
this node subscrive / can_raw topics and decode available imformation like Obstacle Number, 
Obstacle Position, Lane Distance from my vehicle etc..thereafter Publish / Mobileye_new topic.
*/
...
int main (int argc, char *argv[]){
  ...
  ros::init(argc, argv, "can_Mobileye_Decoder");					// Node Name
  ros::NodeHandle n;
  ros::Subscriber sub = n.subscribe("can_raw", 1, chatterCallback);
  ros::Publisher Mobileye_pub = n.advertise<autoware_msgs::Mobileye_New>("Mobileye_New", 1);
